...
//#region resources/js/Pages/Kelas/Edit.vue
var _sfc_main = {
	__name: "Edit",
	...
	setup(__props) {
		...
		return (_ctx, _push, _parent, _attrs) => {
			_push(`<!--[-->`);
			_push(ssrRenderComponent(unref(Head), { title: "Edit Kelas" }, null, _parent));
			_push(ssrRenderComponent(_sfc_main$4, null, {
				header: withCtx((_, _push, _parent, _scopeId) => {
					if (_push) _push(`<h2 class="font-bold text-lg theme-text"${_scopeId}>Edit Kelas</h2>`);
					else return [createVNode("h2", { class: "font-bold text-lg theme-text" }, "Edit Kelas")];
				}),
...
_sfc_main.setup = (props, ctx) => {
	...
	(ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Kelas/Edit.vue");
